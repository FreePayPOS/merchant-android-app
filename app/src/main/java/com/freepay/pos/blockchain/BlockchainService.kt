...
class BlockchainService(private val context: Context) {
    ...
    companion object {
        ...
        private val STABLECOIN_ADDRESSES = mapOf(
            ...
            10 to mapOf(
                "USDC" to TokenInfo("0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85", 6),
                "USDC.e" to TokenInfo("0x7F5c764cBc14f9669B88837ca1490cCa17c31607", 6),
                "USDT" to TokenInfo("0x94b008aA00579c1307B0EF2c499aD98a8ce58e58", 6),
                "DAI" to TokenInfo("0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1", 18)
            ),
            137 to mapOf(
                "USDC" to TokenInfo("0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359", 6),
                "USDC.e" to TokenInfo("0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174", 6),
                "USDT" to TokenInfo("0xc2132D05D31c914a87C6611C10748AEb04B58e8F", 6),
                "DAI" to TokenInfo("0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063", 18)
            ),
            42161 to mapOf(
                "USDC" to TokenInfo("0xaf88d065e77c8cC2239327C5EDb3A432268e5831", 6),
                "USDC.e" to TokenInfo("0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8", 6),
                "USD₮0" to TokenInfo("0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", 6),
                "DAI" to TokenInfo("0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1", 18)
            ),
            8453 to mapOf(
